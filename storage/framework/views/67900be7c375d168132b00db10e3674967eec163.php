                            ...
                            <div>
                                <?php if($post->user->avatar == null): ?>
                                    <img class="w-12 h-12 rounded-full object-cover mr-4 shadow"
                                        src="<?php echo e(asset('/img/profile.png')); ?>" alt="avatar">
                                <?php else: ?>
                                    <img class="w-12 h-12 rounded-full object-cover mr-4 shadow"
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.dropdown','data' => ['align' => 'right','width' => '48','class' => '']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['align' => 'right','width' => '48','class' => '']); ?>
                             ...
                             <?php $__env->slot('content', null, []); ?> 
                                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.dropdown-link','data' => ['href' => route('post.edit', $post->slug)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('post.edit', $post->slug))]); ?>
                                    <?php echo e(__('Edit')); ?>
...
<?php endif; ?>
                                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.dropdown-link','data' => ['xData' => '','xOn:click.prevent' => '$dispatch(\'open-modal\', \'confirm-post-deletion\')']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('dropdown-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['x-data' => '','x-on:click.prevent' => '$dispatch(\'open-modal\', \'confirm-post-deletion\')']); ?>
...
<?php endif; ?>
                ...
                <a href="<?php echo e(route('post.show', $post->slug)); ?>" class="mt-4 text-cyan-900 text-sm text-justify">
                    <h1 class="text-xl font-weight-bold my-2"><?php echo e($post->title); ?></h1>
                ...
                <div class="mt-4 text-cyan-900 flex justify-end space-x-2">
                    ...
                    <div class="flex items-center">
                        <a href="<?php echo e(route('post.show', $post->slug)); ?>" class="flex items-center space-x-1">
        ...
        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal','data' => ['name' => 'confirm-post-deletion','show' => $errors->postDeletion->isNotEmpty(),'focusable' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'confirm-post-deletion','show' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->postDeletion->isNotEmpty()),'focusable' => true]); ?>
            <form method="post" action="<?php echo e(route('post.destroy', $post->slug)); ?>" class="p-6">
                <?php echo csrf_field(); ?>
                ...
                <p class="mt-1 text-sm text-gray-600">
                    <?php echo e(__('Once your post is deleted, all of its resources and data will be permanently deleted.')); ?>
            ...
            <div class="py-6 w-full text-center text-cyan-900 mt-4">
                <svg class="mx-auto" width="300" height="256" viewBox="0 0 300 256" fill="none"
                    ...
                    <path opacity="0.1"
                        ...
                        fill="#55C595" />
                    <path d="M234.512 186.696L151.564 230.505L68.7412 186.696V120.54H234.512V186.696Z" fill="white" />
                    <path
...
<?php endif; ?>
<?php /**PATH D:\applications\animalie\resources\views/profile/myPost.blade.php ENDPATH**/ ?>