@if ($posts->count())
    <div class="post-data">
                    ...
                    <div class="flex justify-between">
                        ...
                        <div class="flex justify-end">
                            ...
                            <x-dropdown align="right" width="48" class="">
                                <x-slot name="trigger">
                                    <button>
                                        <i data-icon="mdi:dots-vertical" class="iconify" data-height="24"
                                            data-width="24" color="#164e63"></i>
                                    </button>
                                </x-slot>
                                <x-slot name="content">
        ...
        <x-modal id="confirm-post-deletion" name="confirm-post-deletion" :show="$errors->postDeletion->isNotEmpty()" focusable>
            <div class="p-6">
                ...
                <div class="mt-6 flex justify-end">
                    ...
                    <x-danger-button class="ml-3" id="delete-post" x-on:click="$dispatch('close')">
                        {{ __('Delete Post') }}
                    </x-danger-button>
                </div>
            </div>
