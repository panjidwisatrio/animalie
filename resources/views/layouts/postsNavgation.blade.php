<div class="max-w-4xl lg:mx-auto sm:text-sm px-3 md:py-0 lg:py-0 lg:px-8">
    <div class="bg-white overflow-hidden lg:shadow-lg lg:rounded-t-xl">
        <div
            class=" py-4 lg:p-6 lg:text-mf text-cyan-900 flex justify-between lg:justify-between border-b-2 sm:border-gray-200">
            <div class="flex">
                {{-- Sub Navigation --}}
                <div class="space-x-8 lg:hidden sm:visible flex items-center ">
                        ...
                        <x-slot name="trigger">
                            <button
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    transform="rotate(90)" viewBox="0 0 24 24" fill="none" stroke="currentColor"
            ...
            {{-- Search bar --}}
            <div class="sm:mr-4 space-x-8 lg:-my-px lg:ml-10 lg:flex">
