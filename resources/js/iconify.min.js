...
var Iconify = function(e) {
    ...
    function v(e) {
        ...
        for (var c in a) {
            var s = a[c],
                f = s.parent;
            if (!c.match(u) || "string" != typeof f || !t[f] && !a[f] || !l(s, i)) return null
        }
        return n
    }
    ...
    function M(e, n) {
        ...
        var c, u, s = i.width,
            ...
            d = o.width,
            l = o.height;
        return null === s ? c = C(u = null === f ? "1em" : "auto" === f ? l : f, d / l) : (c = "auto" === s ? d : s, u = null === f ? C(c, l / d) : "auto" === f ? l : f), {
            attributes: {
                width: c.toString(),
                height: u.toString(),
                viewBox: o.left.toString() + " " + o.top.toString() + " " + d.toString() + " " + l.toString()
            },
            body: a
        }
    }
    ...
    function K(e, n) {
        ...
        if (t) {
            ...
            for (var a = Math.floor(Date.now() / R) - 168, c = function(e) {
                    var r = D + e.toString(),
                        i = U(t, r);
                    if ("string" == typeof i) {
                        try {
                ...
                }, u = G(t), s = u - 1; s >= 0; s--) c(s) || (s === u - 1 ? (u--, Q(t, u)) : N[e].add(s))
        }
    }
                        ...
                        if (n.length) {
                            ...
                            n.forEach((function(n) {
                                ...
                                o.pending = o.pending.filter((function(n) {
                                    ...
                                    return !1
                                })), o.pending.length !== a && (t || se([e], n.id), n.callback(o.loaded.slice(0), o.missing.slice(0), o.pending.slice(0), n.abort))
                            }))
                        }
                    })))
                }(e)
                ...
                i = function(e) {
                    ...
                    return e.forEach((function(e) {
                        if (r.name !== e.name || r.prefix !== e.prefix || r.provider !== e.provider) {
                            ...
                            (a in u.icons ? n.loaded : "" === o || u.missing.has(a) ? n.missing : n.pending).push(s)
                        }
                    })), n
                }(r);
            if (!i.pending.length) {
                ...
                (function(e) {
                    ...
                    if (!a) {
                        var u = i(r.icon, !0),
                            s = u.status,
                            f = u.icon;
                        return f ? void c(t, r, f) : (o = o || "loading" === s, void(t[Ee] = Object.assign({}, r, {
                            status: s
                        })))
                    }
                    if (function(e, n) {
                    ...
                    c(t, r, n.icon)
                })), e.temporary && !o ? He(t) : n && o ? Ve(t, !0) : a && e.observer && Re(e)
            }
                ...
                if (a || (a = !0, $e(e)), "SVG" !== n.tagName.toUpperCase()) {
                    ...
                    function(e, n, t, r) {
                        var i = n.customisations,
                            ...
                            f = 'url("data:image/svg+xml,' + (l = u, l.replace(/"/g, "'").replace(/%/g, "%25").replace(/#/g, "%23").replace(/</g, "%3C").replace(/>/g, "%3E").replace(/\s+/g, " ") + '")'),
                            d = Object.assign({}, {
                                "--svg": f,
                                width: sn(a.width),
                                height: sn(a.height)
